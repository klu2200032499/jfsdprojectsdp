...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="adminhome">Diet & Nutrition</a>
    ...
    <div class="container mt-5">
        <h3 class="text-center mb-4"><u>Nutritionist Registration</u></h3>

        <!-- Form to Add Nutritionist -->
        <form:form modelAttribute="nutritionist" method="post" action="nutritionistlogin" class="form-container">
